...
################################################
## Creating a function (woodson_pallettes) that 
#################################################
...
########################
  ...
  woodson_pallettes[["orange_blue_diverting_from_purple"]]<-append(rev(cubeHelix(11, start = .5, r = -.4, hue = 1.75, gamma = 1)[3:10]), (cubeHelix(11, start = .5, r = .4, hue = 1.75, gamma = 1)[3:10]))
